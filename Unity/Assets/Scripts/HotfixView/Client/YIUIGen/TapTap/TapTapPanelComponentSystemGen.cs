...
namespace ET.Client
{
    ...
    [EntitySystemOf(typeof(TapTapPanelComponent))]
    public static partial class TapTapPanelComponentSystem
    {
        [EntitySystem]
        private static void Awake(this TapTapPanelComponent self)
        {
        }

        [EntitySystem]
        private static void YIUIBind(this TapTapPanelComponent self)
        {
            self.UIBind();
        }
        
        private static void UIBind(this TapTapPanelComponent self)
        {
